...
os.chdir('/home/athena-admin/Desktop/git_env_new/ClearMap2-Athena')
...
if __name__ == '__main__':
  ...
  directory = '/media/athena-admin/FastSSD/Peter/raw/osfstorage/Brain-39L'
  expression_raw      = 'Raw Data/14-16-41_tricocktail_UltraII[<Y,2> x <X,2>]_C00_UltraII Filter0000.ome.npy'
  expression_arteries = 'Raw Data/14-16-41_tricocktail_UltraII[<Y,2> x <X,2>]_C00_UltraII Filter0001.ome.npy'
  ...
  processing_parameter = vasc.default_binarization_processing_parameter.copy();
  processing_parameter.update(processes = 12,
                              as_memory = True);
